...
echo "Install nginx, php5-fpm"
sudo apt-get install  nginx php5-fpm -y > /dev/null 2>&1
...
sudo apt-get install mysql-client -y > /dev/null 2>&1

echo "Install commonly used php packages"
sudo aptitude install -q -y -f php5-mysql php5-curl php5-gd php5-intl php-pear php5-imagick php5-imap php5-mcrypt php5-memcached php5-ming php5-ps php5-pspell php5-recode php5-sqlite php5-tidy php5-xmlrpc php5-xsl php5-xcache > /dev/null 2>&1
